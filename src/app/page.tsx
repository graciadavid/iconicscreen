  ...
  return (
    <main style={{width:'100vw',height:'100vh',overflow:'hidden',position:'relative',fontFamily:'"Arial Black",Arial,sans-serif'}}>
      ...
      {!isMobile && adsStyle.width > 0 && (
        <div style={{position:'fixed',top:adsStyle.top,left:adsStyle.left,width:adsStyle.width,height:adsStyle.height,zIndex:3,display:'flex',alignItems:'center',justifyContent:'center',background:'#ffffff'}}>
