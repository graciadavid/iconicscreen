...
export function AppleMobile() {
  return (
    <div style={{position:'absolute',...MOBILE_ADS,zIndex:3,display:'flex',alignItems:'center',justifyContent:'center',background:'#ffffff'}}>
      <div style={{textAlign:'center',display:'flex',flexDirection:'column',alignItems:'center',gap:'2px'}}>
        <svg width="24" height="29" viewBox="0 0 814 1000" fill="#000">
        ...
        <div style={{fontSize:'clamp(5px,1.8vw,10px)',fontWeight:900,color:'#000',letterSpacing:'1px'}}>Think Different.</div>
      </div>
    </div>
  )
}
