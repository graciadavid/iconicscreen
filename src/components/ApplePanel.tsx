...
export function ApplePanel({ style }: Props) {
  if (style.width === 0) return null
  return (
    <div style={{position:'fixed',top:style.top,left:style.left,width:style.width,height:style.height,zIndex:3,display:'flex',alignItems:'center',justifyContent:'center',background:'#ffffff'}}>
